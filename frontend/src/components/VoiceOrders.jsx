                ...
                <div className="glass-card" style={{ padding: 32, textAlign: 'center' }}>
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6, marginTop: 14, justifyContent: 'center' }}>
                        {[
                            ...
                            'two margherita pizza extra cheese',
                            'one cold coffee and chocolate brownie',
                        ].map(ex => (
                            <button
                                key={ex}
                                onClick={() => { setManualText(ex); parseOrder(ex) }}
                                style={{
                                    padding: '5px 10px', fontSize: 11, background: 'var(--bg-elevated)',
                                        ...
                                        <div key={i} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '8px 0', borderBottom: '1px solid rgba(0,0,0,0.04)' }}>
                                            <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                                                <span style={{
                                                    ...
                                                    background: 'var(--bg-elevated)', fontSize: 12, fontWeight: 700
                                                }}>{i + 1}</span>
                                                <div>
                                                    ...
                                                    {item.modifiers?.filter(Boolean).length > 0 && (
                                                        <div style={{ display: 'flex', gap: 4, marginTop: 2 }}>
                                                            {item.modifiers.filter(Boolean).map((mod, j) => (
                                                                <span key={j} style={{ fontSize: 10, background: 'var(--bg-elevated)', color: 'var(--text-tertiary)', padding: '2px 6px', borderRadius: 4 }}>
                                                                    {mod}
                                                                </span>
                                                            ))}
                                                        </div>
                                ...
                                <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
                                    ...
                                    <div style={{ flex: 1 }}>
                                        ...
                                        <p style={{ fontSize: 13, color: 'var(--text-secondary)', marginBottom: 12 }}>
                                            {parsedOrder.upsell_suggestion.message}
                                        </p>
